      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-white">Terminal Central</h1>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="text-center">
              <p className="text-xs text-gray-500">
                ...
                <button className="text-blue-600 hover:text-blue-500">Términos de Servicio</button>
                {' '}y{' '}
                <button className="text-blue-600 hover:text-blue-500">Política de Privacidad</button>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <div className="flex justify-center space-x-4 text-sm text-gray-600">
            ...
            <button className="hover:text-gray-900 transition-colors">App Móvil</button>
          </div>
        </div>
      </div>
    </div>
