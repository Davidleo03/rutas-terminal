 ...
 */
const ModalRegistroTRByEmpresa = ({ open, onClose, initialData = null, onSubmit, onDone }) => {
  const defaultForm = {
    id_ruta: '',
    id_bus: '',
  ...
  const { data: rutasData = [], isLoading: isLoadingRutas } = useRutasByEmpresa(user?.id_empresa);
...
export default ModalRegistroTRByEmpresa;
